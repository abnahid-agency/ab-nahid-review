...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a marketing expert who specializes in generating realistic google reviews.

  Write a natural, human-sounding Google review for a digital services company called Ab Nahid Agency.
  ...
  Write the review in a friendly tone, use 3–5 sentences, and make it sound completely authentic.
